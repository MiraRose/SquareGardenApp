    ...
    return {
      plots: {
        ...
        veggies: 
            ...
            {            
            'Asparagus': {'friends':'Dill, tomatoes, basil', 'img':'../../assets/images/svg/veggies/048-asparagus.svg'},
            'Basil': {'friends':'Chamomile', 'img':'../../assets/images/svg/veggies/002-basil.svg'},
            'Beans': {'friends':'Cucumbers, cabbage, carrots, corn, marigolds, potato, radish, lettuce, onion', 'img':'../../assets/images/svg/veggies/legumes.svg'},
            'Broccoli': {'friends':'Dill, lettuce, onions, tomato, spinach', 'img':'../../assets/images/svg/veggies/018-broccoli.svg'},
            'Cabbage': {'friends':'Beans, chamomile, marigold, dill, tomato', 'img':'../../assets/images/svg/veggies/042-cabbage.svg'},
            'Cantalope': {'friends':'Corn', 'img':'../../assets/images/svg/veggies/035-melon.svg'},
            'Carrot': {'friends':'Lettuce, onion, beans, strawberries', 'img':'../../assets/images/svg/veggies/001-carrot.svg'},
            'Chamomile': {'friends':'None', 'img':'../../assets/images/svg/veggies/007-chamomile.svg'},
            'Chili Pepper': {'friends':'Beans, tomatos, onions', 'img':'../../assets/images/svg/veggies/028-chili.svg'},
            'Corn': {'friends':'Dill, beans, potatos', 'img':'../../assets/images/svg/veggies/040-corn.svg'},
            'Cucumber': {'friends':'Radishes, chamomile, marigold, peas, beans, carrots, dill, onions, garlic', 'img':'../../assets/images/svg/veggies/044-cucumber.svg'},
            'Dill': {'friends':'broccoli, cabbage, corn, eggplant, lettuce, onions, cucumbers', 'img':'../../assets/images/svg/veggies/dill.svg'},
            'Eggplant': {'friends':'Marigold, dill, beans', 'img':'../../assets/images/svg/veggies/011-eggplant.svg'},
            'Garlic': {'friends':'Peas', 'img':'../../assets/images/svg/veggies/034-garlic.svg'},
            'Green Onions': {'friends':'Carrots, dill, lettuce, marigolds, tomatos', 'img':'../../assets/images/svg/veggies/010-spring-onion.svg'},
            'Lettuce': {'friends':'Broccoli, carrots, dill, radish, onions, beans, broccoli', 'img':'../../assets/images/svg/veggies/036-lettuce.svg'},
            'Marigold': {'friends':'Most plants', 'img':'../../assets/images/svg/veggies/marigold.svg'},
            'Onion': {'friends':'Carrots, chamomile, strawberries, dill, lettuce, marigolds, tomatos', 'img':'../../assets/images/svg/veggies/023-onion.svg'},
            'Peas': {'friends':'Garlic', 'img':'../../assets/images/svg/veggies/022-peas.svg'},
            'Pepper': {'friends':'Beans, tomatos, onions, basil', 'img':'../../assets/images/svg/veggies/012-bell-pepper.svg'},
            'Potato': {'friends':'Beans, marigolds, peas, onion, garlic', 'img':'../../assets/images/svg/veggies/013-potato.svg'},
            'Pumpkin': {'friends':'Radishes', 'img':'../../assets/images/svg/veggies/002-pumpkin.svg'},
            'Radish': {'friends':'Lettuce', 'img':'../../assets/images/svg/veggies/021-radish.svg'},
            'Spinach': {'friends':'Strawberries, peas, beans', 'img':'../../assets/images/svg/veggies/legumes.svg'},
            'Strawberries': {'friends':'Bush beans, onions', 'img':'../../assets/images/svg/veggies/016-strawberry.svg'},
            'Tomato': {'friends':'Asparagus, basil, beans, marigold, garlic, corn, dill, carrots, eggplant', 'img':'../../assets/images/svg/veggies/003-tomato.svg'},
            'Watermelon': {'friends':'Corn', 'img':'../../assets/images/svg/veggies/006-watermelon.svg'}
        }
  ...
  created: function () {
        ...
        for (let i = 0; i < this.dimensions.height; i++) {
            ...
            for (var x = 0; x < this.dimensions.width; x++) {
                this.plots[i][x] = { selected: '', suggestion: 'none', partner: '', image: '../../assets/images/svg/veggies/dirt.svg' };
            }
        }
    },
